...
import cofh.thermal.dynamics.common.block.entity.duct.ItemDuctWindowedBlockEntity;
...
public class TDynBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<?>> ITEM_DUCT_BLOCK_ENTITY = BLOCK_ENTITIES.register(ID_ITEM_DUCT, () -> BlockEntityType.Builder.of(ItemDuctBlockEntity::new, BLOCKS.get(ID_ITEM_DUCT)).build(null));
    public static final RegistryObject<BlockEntityType<?>> ITEM_DUCT_WINDOWED_BLOCK_ENTITY = BLOCK_ENTITIES.register(ID_ITEM_DUCT_WINDOWED, () -> BlockEntityType.Builder.of(ItemDuctWindowedBlockEntity::new, BLOCKS.get(ID_ITEM_DUCT_WINDOWED)).build(null));
