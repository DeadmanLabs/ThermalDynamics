...
public class TDynContainers {
    ...
    public static final RegistryObject<MenuType<ItemFilterAttachmentMenu>> ITEM_FILTER_ATTACHMENT_CONTAINER = CONTAINERS.register(ID_ITEM_FILTER_ATTACHMENT, () -> IForgeMenuType.create((windowId, inv, data) -> new ItemFilterAttachmentMenu(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), data.readEnum(Direction.class), inv, ProxyUtils.getClientPlayer())));
    public static final RegistryObject<MenuType<ItemServoAttachmentMenu>> ITEM_SERVO_ATTACHMENT_CONTAINER = CONTAINERS.register(ID_ITEM_SERVO_ATTACHMENT, () -> IForgeMenuType.create((windowId, inv, data) -> new ItemServoAttachmentMenu(windowId, ProxyUtils.getClientWorld(), data.readBlockPos(), data.readEnum(Direction.class), inv, ProxyUtils.getClientPlayer())));
