...
import cofh.thermal.dynamics.common.attachment.ItemFilterAttachment.FilterMode;
...
public class ItemFilterAttachmentScreen extends ContainerScreenCoFH<ItemFilterAttachmentMenu> {
    ...
    public void init() {
        ...
        for (int i = 0; i < menu.getFilterSize(); ++i) {
            ...
            final int j = i;
            addElement(new ElementItem(this, slot.x, slot.y).setItem(() -> menu.getFilterStacks().get(j)).setSize(16, 16));
        }
        addButtons();
    }
